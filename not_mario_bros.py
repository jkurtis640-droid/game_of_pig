...
def flip_enemies_on_platform(platform_id):
    x1, y1, x2, y2 = canvas.coords(platform_id)
...
def check_enemy_collision():
    global alive, lives, PLAYER_DX, PLAYER_DY, player
...
def update():
    ...
    flip_enemies_on_platform(platform_id)
